...
function createModelLifeCycles(name) {
  strapi.log.debug('Revision Plugin - createModelLifeCycles name: ', name);
  const strapiModel = strapi.models[name];
  strapi.log.debug('Revision Plugin - createModelLifeCycles strapiModel: ', strapiModel);
...
async function createRevision(data) {
  strapi.log.debug('CreateRevision: ',data);
  // tu trzeba wpisywac do historii
  // strapi.log.debug('`Revision Plugin createRevision plug: ', strapi.plugins['strapi-plugin-revisions']);
  // strapi.log.debug('`Revision Plugin createRevision plug2: ', strapi.plugins['myplugin']);
  strapi.log.debug('`Revision Plugin createRevision user: ', strapi.plugins['users-permissions']);
  // strapi.log.debug('`Revision Plugin createRevision models: ', strapi.models);
  // strapi.log.debug('`Revision Plugin createRevision contentTypes: ', strapi.contentTypes);
